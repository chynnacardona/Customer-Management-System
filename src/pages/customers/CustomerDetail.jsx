    ...
    return (
      <>
        ...
        <div className="customer-detail-page">
          ...
          <div className={`detail-empty-state ${error ? 'detail-error-state' : ''}`}>
            {error || `Customer ${custno} not found in database.`}
          </div>
        </div>
      </>
    )
...
const pageStyles = `
  ...
  .detail-hero { display: flex; gap: 16px; background: linear-gradient(180deg, rgba(126, 184, 255, 0.035), transparent 44%), linear-gradient(145deg, rgba(8, 18, 40, 0.84), rgba(3, 9, 24, 0.9)); border: 1px solid rgba(126, 184, 255, 0.12); border-radius: 18px; padding: 18px; box-shadow: 0 18px 38px rgba(0, 0, 0, 0.28), inset 0 1px 0 rgba(255,255,255,0.045); animation: detailCardIn 0.38s cubic-bezier(0.22, 1, 0.36, 1) both; transition: transform 0.22s ease, border-color 0.22s ease, box-shadow 0.22s ease; }
  .detail-hero:hover { transform: translateY(-2px); border-color: rgba(126, 184, 255, 0.24); box-shadow: 0 22px 48px rgba(0, 0, 0, 0.34), inset 0 1px 0 rgba(255,255,255,0.07); }
  ...
  .detail-meta-card { display: flex; align-items: center; gap: 10px; background: rgba(126, 184, 255, 0.045); border: 1px solid rgba(126, 184, 255, 0.08); border-radius: 12px; padding: 12px; color: rgba(126, 184, 255, 0.75); min-width: 0; transition: transform 0.2s ease, border-color 0.2s ease, background 0.2s ease; }
  .detail-meta-card:hover { transform: translateY(-1px); border-color: rgba(126, 184, 255, 0.18); background: rgba(126, 184, 255, 0.07); }
  ...
  .detail-error-state { border-color: rgba(248, 113, 113, 0.2); background: rgba(239, 68, 68, 0.08); color: rgba(252, 165, 165, 0.95); }
